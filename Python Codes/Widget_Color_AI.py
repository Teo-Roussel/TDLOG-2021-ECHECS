...
# Form implementation generated from reading ui file 'Widget_Color_AI.ui'
#
...
class Window_Choice(object):
    def __init__(self, PVP, MainWindowAssoc, Initial_WindowAssoc, FEN=None):
        ...
        self.WindowAssoc.setStyleSheet("background-color : rgb(255,255,222);border : 2px solid rgb(180,0,0);")
        ...
        self.nameText.setStyleSheet("border-color : rgb(80,0,0);\n border-width : 2px; \n border-style : inset;")
        ...
        if not self.PVP:
            ...
            self.colorText.setStyleSheet("border-color : rgb(80,0,0);\n border-width : 2px; \n border-style : inset;")
        ...
        if self.PVP:
            ...
            self.nameText2.setStyleSheet("border-color : rgb(80,0,0);\n border-width : 2px; \n border-style : inset;")
        ...
        self.openGameButton.setStyleSheet("background-color : rgb(120,0,0); color : rgb(195,195,195)")
        ...
        self.handleFileButton.setStyleSheet("background-color : rgb(120,0,0); color : rgb(195,195,195)")
    ...
    def retranslateUi(self):
        ...
        if not self.PVP:
            self.colorText.setText(_translate("Form", "Which color do you want to play ?"))
    ...
    def open_Game(self):
        ...
        self.WindowOpen = PlW.ErW.Ui_SaveWindow(MainWindow,self.PVP, InitialWindowAssoc = self.IwAssoc, playWindowAssoc = self.PW.playWin)
    ...
    def handle_File(self):
        MainWindow = QtWidgets.QMainWindow()
        self.WindowHandle = PlW.HdF.Ui_MainWindow(MainWindow, self.PVP, InitialWindowAssoc = self.IwAssoc, playWindowAssoc = None)
        self.WindowHandle.WindowHandle.show()

    def open_PlayWindowPVP(self):
        self.PW = PlW.Game(True, self.IwAssoc, self.nameW, nameP2=self.nameB,FEN = self.FEN)
        self.IwAssoc.MainWindow.close()
        self.WindowAssoc.close()
        self.PW.show()

    def open_playwindowAI(self):
        self.PW = PlW.Game(False, self.IwAssoc, self.namePlayer, colorAI=self.colorAI,FEN = self.FEN)
        self.IwAssoc.MainWindow.close()
        self.WindowAssoc.close()
        self.PW.show()
